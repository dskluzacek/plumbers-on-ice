...
public class RectangleTest {
	...
	public static void main(String[] args) {
		...
		print( rect.staticCollisionInfo(rect2) );
		assert( rect.staticCollisionInfo(rect2).getDirection() == Direction.TOP );
		assert( rect.staticCollisionInfo(rect2).getDistance() == 0 );
		...
		print( rect.staticCollisionInfo(rect2) );
		assert( rect.staticCollisionInfo(rect2).getDirection() == Direction.LEFT );
		assert( rect.staticCollisionInfo(rect2).getDistance() == 0 );
		
		rect2 = new Rectangle(90, 90, 10, 10);
		print( rect.staticCollisionInfo(rect2) );
		assert( rect.staticCollisionInfo(rect2).getDirection() == Direction.BOTTOM );
		assert( rect.staticCollisionInfo(rect2).getDistance() == 0 );
		
		rect2 = new Rectangle(90, 100, 10, 10);
		print( rect.staticCollisionInfo(rect2) );
		assert( rect.staticCollisionInfo(rect2).getDirection() == Direction.RIGHT );
		assert( rect.staticCollisionInfo(rect2).getDistance() == 0 );

		rect2 = new Rectangle(105, 129, 10, 10);
		print( rect.staticCollisionInfo(rect2) );
		assert( rect.staticCollisionInfo(rect2).getDirection() == Direction.TOP );
		assert( rect.staticCollisionInfo(rect2).getDistance() == 1 );
		
		rect2 = new Rectangle(115, 125, 10, 10);
		print( rect.staticCollisionInfo(rect2) );
		assert( rect.staticCollisionInfo(rect2).getDirection() == Direction.TOP );
		assert( rect.staticCollisionInfo(rect2).getDistance() == 5 );
		...
		print( rect.staticCollisionInfo(rect2) );
		assert( rect.staticCollisionInfo(rect2).getDirection() == Direction.BOTTOM );
		assert( rect.staticCollisionInfo(rect2).getDistance() == 4 );
