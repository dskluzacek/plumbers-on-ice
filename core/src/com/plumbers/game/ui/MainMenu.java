...
//            CASTLE_LEVEL = 5;
    ...
    public void show() {
        ...
        Button singlePlayerButton 
            = new Button(btnX, btnY + 3*btnDiff, btnWidth, btnHeight,
                    new Button.Listener() {
                        public void action() {
        ...
        Button multiplayerButton
            = new Button(btnX,  btnY + 2*btnDiff, btnWidth, btnHeight,
                    new Button.Listener() {
                        public void action() {
        ...
        Button accountButton
            = new Button(btnX, btnY + 1*btnDiff, btnWidth, btnHeight,
                    new Button.Listener() {
                        public void action() {
        ...
        Button chooseCharButton
            = new Button( btnX,  btnY, btnWidth, btnHeight,
                    new Button.Listener() {
                        public void action() {
    ...
    private class LevelsMenu extends ScreenAdapter {
        ...
        public LevelsMenu() {
            ...
            buttons[0] = new Button(510, 360, 340, 330,
                    new Button.Listener() {
                        public void action() {
                            PlumbersOnIceGame.startSinglePlayer(LEVEL_1_FILE, characterChoice);
                        }
                    });
            
            buttons[1] = new Button(790, 360, 340, 330,
                    new Button.Listener() {
                        public void action() {
                            PlumbersOnIceGame.startSinglePlayer(LEVEL_2_FILE, characterChoice);
                        }
                    });
            
            buttons[2] = new Button(1210, 360, 340, 330,
                    new Button.Listener() {
                        public void action() {
                            PlumbersOnIceGame.startSinglePlayer(LEVEL_3_FILE, characterChoice);
                        }
                    });
            buttons[3] = new Button(570, 130, 340, 330,
                    new Button.Listener() {
                        public void action() {
                            PlumbersOnIceGame.startSinglePlayer(LEVEL_4_FILE, characterChoice);
                        }
                    });
            buttons[4] = new Button(1010, 130, 340, 330,
                new Button.Listener() {
                    public void action() {
                        PlumbersOnIceGame.startSinglePlayer(LEVEL_5_FILE, characterChoice);
                    }
                });
